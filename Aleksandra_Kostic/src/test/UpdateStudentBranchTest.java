...
import java.net.URL;
public class UpdateStudentBranchTest {
  ...
  @Test
  public void updateStudentBranch() {
    ...
    assertThat(driver.findElement(By.cssSelector("tr:nth-child(1) > td:nth-child(3)")).getText(), is("label=MCA"));
  }
}
