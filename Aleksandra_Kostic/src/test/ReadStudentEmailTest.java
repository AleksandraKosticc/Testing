...
import java.net.URL;
public class ReadStudentEmailTest {
  ...
  public void readStudentEmail() {
    ...
    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr[1]/td[2]")).getText(), is("aleksandra.kosticc@gmail.com"));
  }
}
