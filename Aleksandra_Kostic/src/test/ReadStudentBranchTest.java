...
import java.net.URL;
public class ReadStudentBranchTest {
  ...
  public void readStudentBranch() {
    ...
    assertThat(driver.findElement(By.xpath("/html/body/app-root/div/app-student-list/div[1]/div[2]/div/table/tbody/tr[1]/td[3]")).getText(), is("label=B-Tech"));
  }
}
